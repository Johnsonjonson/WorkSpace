...
class Surface(ttk.Frame):
    ...
    def __init__(self, win):
        ...
        self.user_shuaka_time = ttk.Label(frame_right3, text="刷卡时间：")
        self.user_shuaka_time.grid(column=0, row=2, sticky=tk.W)
        self.user_car_num = ttk.Label(frame_right3, text="车牌号码：")
        self.user_car_num.grid(column=0, row=3, sticky=tk.W)
        self.user_name = ttk.Label(frame_right3, text='所属单位：')
        self.user_name.grid(column=0, row=4, sticky=tk.W)
        self.user_car_type = ttk.Label(frame_right3, text="车辆型号：")
        self.user_car_type.grid(column=0, row=5, sticky=tk.W)
    ...
    def update_user_info(self,data):
        self.user_name.configure(text="所属单位："+data['name'], state='enable')
        self.user_car_num.configure(text="车牌号码："+data['car_num'], state='enable')
        self.user_car_type.configure(text="车辆型号："+data['car_type'], state='enable')
        self.user_shuaka_time.configure(text="刷卡时间："+data['time'], state='enable')
