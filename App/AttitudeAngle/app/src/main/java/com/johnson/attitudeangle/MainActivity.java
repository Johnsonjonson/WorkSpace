package com.johnson.attitudeangle;
...
import com.johnson.attitudeangle.bean.AngleBean;
import com.johnson.attitudeangle.http.NameValuePair;
import com.johnson.attitudeangle.http.OkHttpUtil;
...
//        lp.layoutInDisplayCutoutMode = WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_DEFAULT;
        ...
        yaw.setText("Yaw：");
        yaw.setTextColor(getResources().getColor(R.color.green));
        pitch = findViewById(R.id.pitch);
        pitch.setText("Pitch：" );
        pitch.setTextColor(getResources().getColor(R.color.green));
        roll = findViewById(R.id.roll);
        roll.setText("Roll：" );
        roll.setTextColor(getResources().getColor(R.color.green));
                    ...
                    try {
                        ...
                        new Handler(MainActivity.getActivity().getMainLooper()).post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Log.d("result ===  ",result);
                                Gson gson = new Gson();
                                AngleBean angleBean = gson.fromJson(result, AngleBean.class);
                                JsonObject jsonObject = new JsonObject();
                                Log.d("result ===  ",angleBean.getYaw()+"    "+angleBean.getPitch()+"    "+angleBean.getRoll());
//                                double parseDouble = Double.parseDouble(tempResult);
                                pitch.setText("Pitch："+angleBean.getPitch() );
                                yaw.setText("Yaw：" + angleBean.getYaw());
                                roll.setText("Roll：" + angleBean.getRoll());
