...
class streamDetectionPlot(object):
    ...
    def anomalyDetectionPlot(self, timestamp, actualValue, predictValue, anomalyScore):
        ...
        self.timestampRange = [min(self.timestamp), max(self.timestamp)+datetime.timedelta(seconds=10)]
...
#     graph.anomalyDetectionPlot(timestamp,random.randint(0,100),random.randint(0,100),random.randint(0,100))