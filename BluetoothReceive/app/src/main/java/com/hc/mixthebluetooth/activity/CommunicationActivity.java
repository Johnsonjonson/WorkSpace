...
import com.hc.mixthebluetooth.fragment.FragmentSendMsg;
...
//    @ViewByIds(value = {R.id.one,R.id.log,R.id.two,R.id.three,R.id.send_msg},name = {"mMessTV","mLogTV","mCustomTV","mOtherTV","mSendTV"})
//    private UnderlineTextView mMessTV,mLogTV,mCustomTV,mOtherTV,mSendTV;//四个滑动标题
    ...
    private IMessageInterface mMessage,mCustom,mThree,mLog,msendMessage;
...
//    @OnClick({R.id.one,R.id.two,R.id.three,R.id.log,R.id.send_msg})
...
//        }
//        msendMessage = (IMessageInterface) manage.addFragment(new FragmentSendMsg());
//        msendMessage.setHandler(mFragmentHandler);
//        msendMessage.readData(FRAGMENT_STATE_SEND_SEND_TITLE,mTitle,null);
...
//                            mUnderlineTV = mSendTV.setState(true);
//                        break;
//                }
            }
        });
...
//                msendMessage.readData(FRAGMENT_STATE_DATA, modules.get(0), data);
            }
...
//                    msendMessage.updateState(CommunicationActivity.FRAGMENT_STATE_1);
                }
                else{
                    mMessage.updateState(CommunicationActivity.FRAGMENT_STATE_2);
//                    msendMessage.updateState(CommunicationActivity.FRAGMENT_STATE_2);
                }
            }
...
//                msendMessage.readData(FRAGMENT_STATE_DATA, modules.get(0), null);
...
//                msendMessage.readData(FRAGMENT_STATE_NUMBER, number, null);
            }
