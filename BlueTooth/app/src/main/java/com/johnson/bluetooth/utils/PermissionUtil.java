package com.johnson.bluetooth.utils;
...
import com.johnson.bluetooth.activity.MainActivity;
...
//        Log.d("janroid","*******************************"+tag);
    ...
    public static boolean checkCoarsePermissions(){
        if(ContextCompat.checkSelfPermission(MainActivity.mActivity, Manifest.permission.ACCESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(
                    MainActivity.mActivity,
    ...
    public static boolean checkFinePermissions(){
        if(ContextCompat.checkSelfPermission(MainActivity.mActivity, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(
                    MainActivity.mActivity,
