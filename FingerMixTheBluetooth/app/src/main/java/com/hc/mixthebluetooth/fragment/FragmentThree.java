...
public class FragmentThree extends BasFragment {
    ...
    @ViewByIds(value = {R.id.general_fragment_height,R.id.general_fragment_centre,R.id.general_fragment_low},
            name = {"mHeightCs","mCentreCs","mLowCs"})
    private CheckBoxSample mHeightCs,mCentreCs,mLowCs;
    ...
    public void readData(int state, Object o, byte[] data) {
        if (state == CommunicationActivity.FRAGMENT_STATE_DATA && o != null){
            ...
            mSendTv.setText(deviceModule.getSendUUID());
            mReadTv.setText(deviceModule.getReadUUID());
        }
