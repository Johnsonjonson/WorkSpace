...
<%--            开<input type="checkbox" class="switch">关--%>
    ...
    <form action="ExcelServlet" method="post">
        <select name="file">
            <option value="C:/apache-tomcat-7.0.103/webapps/ROOT/info.xls">  //从服务器指定位置下载历史数据
            </option>
        </select>
...
<%--    <div id="main" style="width: 600px;height:400px;"></div>--%>
    <script type="text/javascript">
        ...
        function  updateSwitch(switchStatus) {
            ...
            $.ajax({
                type: "get",
                url: 'http://129.204.232.210:8551/switch?',
                data:{
        ...
        function  updateData() {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    lightdata.innerText = result.light
                    tempdata.innerText = result.temp
