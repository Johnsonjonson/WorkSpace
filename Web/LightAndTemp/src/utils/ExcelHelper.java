...
//    } // end of export
    ...
    public static void createExcel(List<InfoData> list) throws SQLException {
        ...
        // 创建一个工作表
        HSSFSheet sheet = workbook.createSheet("光照与温度");
        // 添加表头行
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            cell.setCellValue(student.getLight());
            cell.setCellStyle(cellStyle);

            cell = hssfRow.createCell(2);
            cell.setCellValue(student.getTemp());
            cell.setCellStyle(cellStyle);

        }
        // 保存Excel文件
        try {
            OutputStream outputStream = new FileOutputStream("C:/apache-tomcat-7.0.103/webapps/ROOT/info.xls");
